...
int main()
{
	...
	unsigned long Off_Phase = 100;
	unsigned long On_Phase = 400;
	unsigned long Off_Phase_Step = 5;
	unsigned long On_Phase_Step = 20;
	
	unsigned long Off_Phase_Max = Off_Phase_Step * 99;
